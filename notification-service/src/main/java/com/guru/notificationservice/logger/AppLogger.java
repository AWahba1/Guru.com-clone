package com.guru.notificationservice.logger;
...
public class AppLogger {
    ...
    private static final String LOG_FILE_PATH = "NotificationsLogs.txt";
    private static final SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");

    @Pointcut("execution(* com.guru.notificationservice.messaging.ViewProfileMessageConsumer.*.*(..))")
    public void messagingQueue() {
    }

    @Pointcut("execution(* com.guru.notificationservice.repositories.*.*(..))")
    public void repositoryMethods() {
    }

    @Around("messagingQueue() || repositoryMethods()")
