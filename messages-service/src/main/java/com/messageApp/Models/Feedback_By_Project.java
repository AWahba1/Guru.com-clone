...
public class Feedback_By_Project {
    ...
    public Feedback_By_Project(UUID job_id, Timestamp created_at, UUID feedback_id, UUID client_id, UUID freelancer_id, String client_name, String job_title, boolean satisfied) {
        this.job_id = job_id;
