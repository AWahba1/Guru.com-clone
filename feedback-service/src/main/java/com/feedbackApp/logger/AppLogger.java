package com.feedbackApp.logger;
...
public class AppLogger {
    ...
    private static final String LOG_FILE_PATH = "feedbackAppLogs.txt";
    private static final SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");

//    @Pointcut("execution(* com.guru.messageApp.services.*.*(..))")
//    public void serviceMethods() {
//    }

    @Pointcut("execution(* com.feedbackApp.Controller.*.*(..))")
